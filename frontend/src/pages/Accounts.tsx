  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const registerExtra = {
        ...
        gmail_imap_host: cfg.gmail_imap_host,
        gmail_imap_port: cfg.gmail_imap_port,
        ...
        chatgpt_manual_browser_provider: cfg.chatgpt_manual_browser_provider,
        chatgpt_adspower_api_url: cfg.chatgpt_adspower_api_url,
